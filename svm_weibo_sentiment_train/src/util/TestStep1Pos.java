...
public class TestStep1Pos {
	
	public static void sta() throws Exception {
		
		BufferedReader br =new BufferedReader(new InputStreamReader(new FileInputStream("./_data/pos60000.txt"), "GBK"));
		BufferedReader br2 =new BufferedReader(new FileReader("stopwords.txt"));
		//∑÷¥ ("neg60000-1.txt")
		BufferedWriter bw=new BufferedWriter(new OutputStreamWriter(new FileOutputStream("pos60000-1.txt"), "GBK"));
		 
		//¥…∆ø
		BufferedWriter bw2 =new BufferedWriter(new FileWriter("cp_pos.txt"));
		String s=null;
		String bb=null;//Õ£”√¥ 
